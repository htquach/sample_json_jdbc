...
public class Main {
    ...
    public static void InsertVehiclesFeedToSQL() throws ClassNotFoundException, IOException, InterruptedException {
        ...
        try {
            ...
            for (int w = 0; w < seconds_per_day; w++) {
                Thread.sleep(1000);
                System.out.println(String.format("%.3f%%", (w / ((double) seconds_per_day) * 100)));
                System.out.println("Insert " + w + " of " + seconds_per_day);
